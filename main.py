...
class CheckersApp:
    def __init__(self): 
        ...
        self.mode_image = tk.PhotoImage(file="mode_button.png")  
    ...
    def show_main_menu(self):
        ...
        self.checkers_label.grid(row=0, column=0, columnspan=2, pady=(40, 20))
        ...
        self.play_button.grid(row=1, column=0, padx=(0, 10), pady=10)

        self.mode_button = tk.Button(self.frame, image=self.mode_image, command=self.choose_mode_game, borderwidth=0, bg=MENU_COLOR, activebackground=MENU_COLOR)
        self.mode_button.grid(row=1, column=1, padx=(10, 0), pady=10)
        ...
        self.option_button.grid(row=2, column=0, padx=(0, 10), pady=10)
        ...
        self.exit_button.grid(row=2, column=1, padx=(10, 0), pady=13)

    def choose_mode_game(self):
